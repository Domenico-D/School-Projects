...
Begin VB.Form frmCosLesson 
   ...
   EndProperty
   ForeColor       =   &H00FFFFFF&
   Icon            =   "frmCosLesson.frx":0000
   LinkTopic       =   "Form1"
   Picture         =   "frmCosLesson.frx":424A
   ScaleHeight     =   7200
   ScaleWidth      =   11955
   ...
   Begin VB.Image imgTriExp3 
      Height          =   2055
      Left            =   6720
      Picture         =   "frmCosLesson.frx":13772
      Stretch         =   -1  'True
      Top             =   2400
      Width           =   2415
   End
   Begin VB.Image imgTriExp2 
      Height          =   2175
      Left            =   3240
      Picture         =   "frmCosLesson.frx":13D7E
      Stretch         =   -1  'True
      Top             =   2400
      Width           =   2655
   End
   ...
   Begin VB.Image imgTriExp 
      Height          =   1590
      Left            =   1320
      Picture         =   "frmCosLesson.frx":14450
      Stretch         =   -1  'True
      Top             =   0
      Width           =   1590
   End
   Begin VB.Label lblStep1 
      Alignment       =   2  'Center
      BackStyle       =   0  'Transparent
      Caption         =   $"frmCosLesson.frx":14C2D
      ForeColor       =   &H00FFFFFF&
      Height          =   1575
      Left            =   600
      TabIndex        =   2
   ...
   End
End
Attribute VB_Name = "frmCosLesson"
