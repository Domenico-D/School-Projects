...
Private Sub cmdSubmit_Click()
    ...
    Else
        ...
        If frmUnits.intAnswerStreak >= 3 And optC.Value = True And frmRoles.intRole = 1 Then
            ...
            & "You must mover Cos over to become Cos-1 and then solve by inputting it in your calculator.", vbOKOnly, "Correct Answer"
        ...
        If frmTrigonometry.cmdCosine.Enabled = True And frmTrigonometry.cmdSine.Enabled = False And frmTrigonometry.cmdTangent.Enabled = False And frmUnits.cmdTrig.Enabled = False And _
            frmUnits.cmdGeometry.Enabled = False And frmUnits.cmdQuadratics.Enabled = False And frmUnits.cmdAlgebra.Enabled = False Then
                
            frmLeaderboard.Show
                
        ElseIf frmTrigonometry.cmdCosine.Enabled = True And frmTrigonometry.cmdSine.Enabled = False And frmTrigonometry.cmdTangent.Enabled = False Or _
        ...
        Else
            ...
            frmTrigonometry.cmdCosine.Enabled = False
...
Private Sub TmrCountdown_Timer()
    ...
    Do While intCount = 15
        ...
        ElseIf frmTrigonometry.cmdCosine.Enabled = True And frmTrigonometry.cmdSine.Enabled = False And frmTrigonometry.cmdTangent.Enabled = False Then
