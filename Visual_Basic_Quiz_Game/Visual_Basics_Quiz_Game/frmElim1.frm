...
Private Sub cmdSubmit_Click()
    ...
    Else
        ...
        ElseIf optD.Value = False And frmRoles.intBlock > 0 Then
            ...
            MsgBox "Incorrect, both equations have the same coefficients in front of their y values." _
            & "This allows for you to easily eliminate y and solve for x. Once you have found x, you can re input it into" _
        ...
        'Incorrect Answer
        Else
            MsgBox "Incorrect, in this question, in this question, both equations have the same coefficients in front of their y values." _
            & "This allows for you to easily eliminate y and solve for x. Once you have found x, you can re input it into" _
            & "the equation and solve for y. The correct answer was D:(2,2)" _
            , vbOKOnly, "Incorrect Answer"
