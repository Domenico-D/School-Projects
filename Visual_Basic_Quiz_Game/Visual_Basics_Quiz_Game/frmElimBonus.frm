...
Private Sub cmdSubmit_Click()
    ...
    Else
        ...
        If frmAlgebra.cmdSub.Enabled = False And frmAlgebra.cmdElim.Enabled = True And frmUnits.cmdAlgebra.Enabled = False And _
            frmUnits.cmdGeometry.Enabled = False And frmUnits.cmdQuadratics.Enabled = False And frmUnits.cmdTrig.Enabled = False Then
                
            frmLeaderboard.Show
                
        ElseIf frmAlgebra.cmdSub.Enabled = False And frmAlgebra.cmdElim.Enabled = True Then
            
            frmUnits.Show
            
        Else
            frmAlgebra.Show
            frmAlgebra.cmdElim.Enabled = False
        End If
