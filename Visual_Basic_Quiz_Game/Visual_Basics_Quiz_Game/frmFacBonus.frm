...
Private Sub cmdSubmit_Click()
    ...
    Else
        ...
        ElseIf frmUnits.intAnswerStreak >= 3 And optB.Value = True And frmRoles.intRole = 3 Then
        ...
        If frmQuadratics.cmdFactor.Enabled = True And frmQuadratics.cmdVertex.Enabled = False And frmUnits.cmdQuadratics.Enabled = False And _
            frmUnits.cmdGeometry.Enabled = False And frmUnits.cmdAlgebra.Enabled = False And frmUnits.cmdTrig.Enabled = False Then
                
            frmLeaderboard.Show
                
        ElseIf frmQuadratics.cmdFactor.Enabled = True And frmQuadratics.cmdVertex.Enabled = False Or frmQuadratics.cmdFactor.Enabled = False And frmQuadratics.cmdVertex.Enabled = False Then
    
            frmUnits.Show
            
        Else
            frmQuadratics.Show
            frmQuadratics.cmdFactor.Enabled = False
...
Private Sub TmrCountdown_Timer()
    ...
    Do While intCount = 15
        ...
        If frmQuadratics.cmdFactor.Enabled = False And frmQuadratics.cmdVertex.Enabled = False And frmUnits.cmdQuadratics.Enabled = False And _
            frmUnits.cmdGeometry.Enabled = False And frmUnits.cmdAlgebra.Enabled = False And frmUnits.cmdTrig.Enabled = False Then
