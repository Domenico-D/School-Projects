...
Begin VB.Form frmFacLesson2 
   ...
   EndProperty
   Icon            =   "frmFacLesson2.frx":0000
   LinkTopic       =   "Form1"
   Picture         =   "frmFacLesson2.frx":424A
   ScaleHeight     =   7200
   ScaleWidth      =   11955
   ...
   Begin VB.CommandButton cmdClose 
      Height          =   1575
      Left            =   8640
      Picture         =   "frmFacLesson2.frx":F0C5
      Style           =   1  'Graphical
      TabIndex        =   0
      Top             =   5280
      Width           =   2775
   ...
   End
End
Attribute VB_Name = "frmFacLesson2"
...
'1/23/2018
'ICS ISU - Kingdom of Knowledge - Factor Lesson
'A lesson on how to use the factor method for quadratics.
Option Explicit
