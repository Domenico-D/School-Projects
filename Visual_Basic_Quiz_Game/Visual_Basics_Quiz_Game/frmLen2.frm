VERSION 5.00
Begin VB.Form frmLen2 
   Caption         =   "Kingdom of Knowledge"
   ClientHeight    =   7200
   ClientLeft      =   -1545
   ClientTop       =   6525
   ClientWidth     =   11955
   Icon            =   "frmLen2.frx":0000
   LinkTopic       =   "Form1"
   Picture         =   "frmLen2.frx":424A
   ScaleHeight     =   7200
   ScaleWidth      =   11955
   ...
   Begin VB.Label lblQuestion 
      ...
      Caption         =   "Find the length of a line segment if its endpoints are (2,2) and (10,17)"
      BeginProperty Font 
...
'January 24, 2018
'ICS ISU - Kingdom of Knowledge - Length Question #2
'The second of three consecutive questions on the lesson about the length formula.
Option Explicit
...
Private Sub cmdSubmit_Click()
    ...
    Else
        ...
        ElseIf optD.Value = False And frmRoles.intBlock > 0 Then
            ...
            MsgBox "Incorrect, this distance can be found using the formula sqrt((x2-x1)^2)+(y2-y1)^2). The correct answer was D:17 units" _
