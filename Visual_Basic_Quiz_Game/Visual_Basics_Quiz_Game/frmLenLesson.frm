...
Begin VB.Form frmLenLesson 
   ...
   EndProperty
   ForeColor       =   &H00FFFFFF&
   Icon            =   "frmLenLesson.frx":0000
   LinkTopic       =   "Form1"
   Picture         =   "frmLenLesson.frx":424A
   ScaleHeight     =   7200
   ScaleWidth      =   11955
   ...
   Begin VB.Label lblStep2 
      Alignment       =   2  'Center
      BackStyle       =   0  'Transparent
      Caption         =   $"frmLenLesson.frx":13772
      ForeColor       =   &H00FFFFFF&
      Height          =   735
      Left            =   600
      TabIndex        =   8
   ...
   Begin VB.Label lblStep1 
      Alignment       =   2  'Center
      BackStyle       =   0  'Transparent
      Caption         =   $"frmLenLesson.frx":13806
      ForeColor       =   &H00FFFFFF&
      Height          =   855
      Left            =   1920
      TabIndex        =   5
   ...
   End
End
Attribute VB_Name = "frmLenLesson"
