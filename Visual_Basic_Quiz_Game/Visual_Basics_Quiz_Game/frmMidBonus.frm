VERSION 5.00
Begin VB.Form frmMidBonus 
   Caption         =   "Kingdom of Knowledge"
   ClientHeight    =   7200
   ClientLeft      =   -1740
   ClientTop       =   -9075
   ClientWidth     =   11970
   Icon            =   "frmMidBonus.frx":0000
   LinkTopic       =   "Form1"
   Picture         =   "frmMidBonus.frx":424A
   ScaleHeight     =   7200
   ScaleWidth      =   11970
   ...
   Begin VB.Label lblBonusQuestion 
      Alignment       =   2  'Center
      BackStyle       =   0  'Transparent
      Caption         =   "Find the other endpoint if one endpoint is (2,4) and the midpoint is (-1,2)."
      BeginProperty Font 
   ...
   Begin VB.Image Image1 
      Height          =   1125
      Left            =   5400
      Picture         =   "frmMidBonus.frx":188C1
      Stretch         =   -1  'True
      Top             =   360
      Width           =   1125
   End
End
Attribute VB_Name = "frmMidBonus"
...
'January 22, 2018
'ICS ISU - Kingdom of Knowledge - Bonus Question for Midpoints
...
Private Sub cmdSubmit_Click()
    ...
    Else
        ...
        'Knight Powerup
        If frmUnits.intAnswerStreak >= 3 And optA.Value = True And frmRoles.intRole = 1 Then
        ...
        ElseIf frmUnits.intAnswerStreak >= 3 And optA.Value = True And frmRoles.intRole = 3 Then
        ...
        ElseIf optA.Value = False And frmRoles.intBlock > 0 Then
            ...
            MsgBox "Incorrect, use the formula (x1+x2)/2 and (y1+y2)/2.", vbOKOnly, "Incorrect Answer"
        ...
        If frmGeometry.cmdMidpoint.Enabled = True And frmGeometry.cmdLength.Enabled = False And frmUnits.cmdAlgebra.Enabled = False And _
            frmUnits.cmdGeometry.Enabled = False And frmUnits.cmdQuadratics.Enabled = False And frmUnits.cmdTrig.Enabled = False Then
                
            frmLeaderboard.Show
                
        ElseIf frmGeometry.cmdMidpoint.Enabled = True And frmGeometry.cmdLength.Enabled = False Then
...
Private Sub TmrCountdown_Timer()
    ...
    Do While intCount = 15
        ...
        MsgBox "Time is up! The answer is A:(-4,0)", vbOKOnly, "Timer"
        ...
        If frmGeometry.cmdMidpoint.Enabled = False And frmGeometry.cmdLength.Enabled = False And frmUnits.cmdAlgebra.Enabled = False And _
        frmUnits.cmdGeometry.Enabled = False And frmUnits.cmdQuadratics.Enabled = False And frmUnits.cmdTrig.Enabled = False Then
