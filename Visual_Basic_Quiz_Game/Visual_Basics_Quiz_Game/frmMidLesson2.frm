...
Begin VB.Form frmMidLesson2 
   ...
   EndProperty
   ForeColor       =   &H00FFFFFF&
   Icon            =   "frmMidLesson2.frx":0000
   LinkTopic       =   "Form1"
   Picture         =   "frmMidLesson2.frx":424A
   ScaleHeight     =   7200
   ScaleWidth      =   11955
   ...
   Begin VB.CommandButton cmdClose 
      Height          =   1575
      Left            =   8640
      Picture         =   "frmMidLesson2.frx":F0C5
      Style           =   1  'Graphical
      TabIndex        =   1
      Top             =   5280
      Width           =   2775
   ...
   Begin VB.Label lblStep1 
      Alignment       =   2  'Center
      BackStyle       =   0  'Transparent
      Caption         =   $"frmMidLesson2.frx":13611
      BeginProperty Font 
         Name            =   "DK Crayon Crumble"
         Size            =   15.75
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "frmMidLesson2"
