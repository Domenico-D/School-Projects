VERSION 5.00
Begin VB.Form frmSine3 
   Caption         =   "Kingdom of Knowledge"
   ClientHeight    =   7200
   ClientLeft      =   -1545
   ClientTop       =   6525
   ClientWidth     =   11955
   Icon            =   "frmSine3.frx":0000
   LinkTopic       =   "Form1"
   Picture         =   "frmSine3.frx":424A
   ScaleHeight     =   7200
   ScaleWidth      =   11955
   ...
   Begin VB.Label lblQuestion 
      ...
      Caption         =   "Find the measure of the angle to the nearest degree SinA = 0.3035"
      BeginProperty Font 
...
'January 22, 2018
'ICS ISU - Kingdom of Knowledge - Sine Question 3
'The last Question for Sine
Option Explicit
